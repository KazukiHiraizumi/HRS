...
//var gl=require("child_process").exec;
var gl=require("child_process").spawn;
...
var glfw=gl('glcon');
glfw.stdout.on('data',function(data){
...
glfw.stderr.on('data',function(data){
	console.log('GL:stderr:'+data);
});
glfw.on('close',function(code){
	console.log('GL:close:'+code);
	glfw=null;
});
...
//	closeCB:function(){ this.srv_abort();},
	...
	srv_glwrt:function(){
		console.log('GLWRT:');
		if(glfw!=null){
			glfw.stdin.write('W 0.1 '+pnow()/1000+' 0 1\n');
		}
	},
	srv_glrun:function(){
